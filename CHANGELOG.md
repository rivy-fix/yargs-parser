...
## [22.0.0](https://github.com/rivy-fix/yargs-parser/compare/yargs-parser-v21.1.1...yargs-parser-v22.0.0) (2023-11-20)


### ⚠ BREAKING CHANGES

* drops support for 10 ([#421](https://github.com/rivy-fix/yargs-parser/issues/421))

### Features

* allow the browser build to be imported ([#443](https://github.com/rivy-fix/yargs-parser/issues/443)) ([a89259f](https://github.com/rivy-fix/yargs-parser/commit/a89259ff41d6f5312b3ce8a30bef343a993f395a))


### Bug Fixes

* **build:** fixed automated release pipeline ([1fe9135](https://github.com/rivy-fix/yargs-parser/commit/1fe9135884790a083615419b2861683e2597dac3))
* **deno:** force relese for Deno ([6687c97](https://github.com/rivy-fix/yargs-parser/commit/6687c972d0f3ca7865a97908dde3080b05f8b026))
* esm json import ([#416](https://github.com/rivy-fix/yargs-parser/issues/416)) ([90f970a](https://github.com/rivy-fix/yargs-parser/commit/90f970a6482dd4f5b5eb18d38596dd6f02d73edf))
* **halt-at-non-option:** prevent known args from being parsed when "unknown-options-as-args" is enabled ([#438](https://github.com/rivy-fix/yargs-parser/issues/438)) ([c474bc1](https://github.com/rivy-fix/yargs-parser/commit/c474bc10c3aa0ae864b95e5722730114ef15f573))
* **locale:** Turkish camelize and decamelize issues with toLocaleLowerCase/toLocaleUpperCase ([2617303](https://github.com/rivy-fix/yargs-parser/commit/261730383e02448562f737b94bbd1f164aed5143))
* node version check now uses process.versions.node ([#450](https://github.com/rivy-fix/yargs-parser/issues/450)) ([d07bcdb](https://github.com/rivy-fix/yargs-parser/commit/d07bcdbe43075f7201fbe8a08e491217247fe1f1))
* parse options ending with 3+ hyphens ([#434](https://github.com/rivy-fix/yargs-parser/issues/434)) ([4f1060b](https://github.com/rivy-fix/yargs-parser/commit/4f1060b50759fadbac3315c5117b0c3d65b0a7d8))
* parser should preserve inner quotes ([#407](https://github.com/rivy-fix/yargs-parser/issues/407)) ([ae11f49](https://github.com/rivy-fix/yargs-parser/commit/ae11f496a8318ea8885aa25015d429b33713c314))
* **perf:** address slow parse when using unknown-options-as-args ([#394](https://github.com/rivy-fix/yargs-parser/issues/394)) ([441f059](https://github.com/rivy-fix/yargs-parser/commit/441f059d585d446551068ad213db79ac91daf83a))
* return deno env object ([#432](https://github.com/rivy-fix/yargs-parser/issues/432)) ([b00eb87](https://github.com/rivy-fix/yargs-parser/commit/b00eb87b4860a890dd2dab0d6058241bbfd2b3ec))
* **string-utils:** detect [0,1] ranged values as numbers ([#388](https://github.com/rivy-fix/yargs-parser/issues/388)) ([efcc32c](https://github.com/rivy-fix/yargs-parser/commit/efcc32c2d6b09aba31abfa2db9bd947befe5586b))
* **typescript:** ignore .cts files during publish ([#454](https://github.com/rivy-fix/yargs-parser/issues/454)) ([d69f9c3](https://github.com/rivy-fix/yargs-parser/commit/d69f9c3a91c3ad2f9494d0a94e29a8b76c41b81b)), closes [#452](https://github.com/rivy-fix/yargs-parser/issues/452)


### Code Refactoring

* drops support for 10 ([#421](https://github.com/rivy-fix/yargs-parser/issues/421)) ([3aaf878](https://github.com/rivy-fix/yargs-parser/commit/3aaf8784f5c7f2aec6108c1c6a55537fa7e3b5c1))
